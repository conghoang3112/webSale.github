                    ...
                    <div class="modal-content">
                        <form action="edit" method="post">
                            ...
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                    <label>Image1</label>
                                    <input value="${detail.productImg}" name="image1" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Image2</label>
                                    <input value="${detail.productImg1}" name="image2" type="text" class="form-control" required>
                                </div>
